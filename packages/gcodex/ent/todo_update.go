...
func (tu *TodoUpdate) SetValue(s string) *TodoUpdate {
	tu.mutation.SetValue(s)
	return tu
}

// SetNillableValue sets the "value" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableValue(s *string) *TodoUpdate {
	if s != nil {
		tu.SetValue(*s)
	}
	return tu
...
// SetValue sets the "value" field.
func (tuo *TodoUpdateOne) SetValue(s string) *TodoUpdateOne {
	tuo.mutation.SetValue(s)
	return tuo
}

// SetNillableValue sets the "value" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableValue(s *string) *TodoUpdateOne {
	if s != nil {
		tuo.SetValue(*s)
	}
	return tuo
